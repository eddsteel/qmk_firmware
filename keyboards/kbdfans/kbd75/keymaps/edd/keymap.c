  ...
  switch (keycode) {
     ...
     case KC_IM:
       if (record->event.pressed) {
         ...
         rgblight_set_layer_state(3, !rgblight_get_layer_state(3));
       }
  }
  return true;
}
...
const rgblight_segment_t PROGMEM rgblayer0[] = RGBLIGHT_LAYER_SEGMENTS({0,16,12,225,255});
const rgblight_segment_t PROGMEM rgblayer1[] = RGBLIGHT_LAYER_SEGMENTS({0,16,132,225,255});
const rgblight_segment_t PROGMEM rgblayer2[] = RGBLIGHT_LAYER_SEGMENTS({0,16,220,225,255});

const rgblight_segment_t* const PROGMEM my_rgb_layers[] =
  RGBLIGHT_LAYERS_LIST(rgblayer0, rgblayer1, rgblayer2, inputmethod_layer);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT(
    KC_SLEP,       HYPR(KC_E),    HYPR(KC_F), HYPR(KC_M),  HYPR(KC_X), KC_F17,     KC_F18,     KC_F19,     KC_F20,     KC_F21,     KC_F22,      KC_F23,      KC_F24,     KC_INS,       KC_SLCK,         KILL,
    OSL(2),        RGB_TOG,       RGB_M_P,    RGB_M_B,     RGB_M_SW,   RGB_M_K,    RGB_M_G,    RGB_HUI,    RGB_HUD,    RGB_SAI,    RGB_SAD,     RGB_VAD,     RGB_VAI,    RESET,        RESET,           DEBUG,
    KC_NO,         HYPR(KC_Q),    HYPR(KC_W), HYPR(KC_E),  KC_MR, HYPR(KC_T), HYPR(KC_Y), HYPR(KC_U), HYPR(KC_I), HYPR(KC_O), HYPR(KC_P),  RGB_SPD,     RGB_SPI,    EEP_RST,                       KC_BRIU,
    KC_NO,          HYPR(KC_A),    HYPR(KC_S), HYPR(KC_D),  HYPR(KC_F), HYPR(KC_G), HYPR(KC_H), HYPR(KC_J), HYPR(KC_K), HYPR(KC_L), KC_NO,       KC_NO,                              KC_NO,            KC_BRID,
    KC_MUTE,       KC_NO,         HYPR(KC_Z), HYPR(KC_X),  HYPR(KC_C), HYPR(KC_V), HYPR(KC_B), HYPR(KC_N), HYPR(KC_M), KC_NO,      KC_NO,       KC_NO,       KC_MPLY,                  KC_VOLU,         NKRO,
    OSL(2),        KC_NO,         KC_NO,                               KC_SLEP,    KC_IM,       KC_SLEP,                            KC_NO,       KC_NO,       KC_TRNS,    KC_MRWD,      KC_VOLD,         KC_MFFD
  )
